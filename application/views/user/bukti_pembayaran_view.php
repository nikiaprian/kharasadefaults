...
<body>
  ...
  <table width="910" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="100%" colspan="4">
        <div align="center" class="style1"><strong><?php echo strtoupper($kost['nama_kost']); ?></strong><br>
          ...
          Website : kharasahouse.com E-Mail : <?php echo $kost['email_kost']; ?> </div>
      </td>
    <tr>
      <td colspan="4"></td>
    </tr>
    ...
    <tr height="30px">
      ...
      <td></td>
      <td colspan="2">
        <div align="center"><strong>PEMILIK KOST</strong>
      </td>
    </tr>
    <tr height="30px">
      ...
      <td></td>
      <td colspan="2">
        <div align="center"><img width="200px" src="<?= base_url('assets'); ?>/images/ttdscan.png" alt="TTD PEMILIK"></div>
      </td>
    </tr>
    <tr height="30px">
      <td></td>
      <td></td>
      <td colspan="2">
        <div align="center"><strong><?php echo strtoupper($pemilik['nama_pengguna']); ?></strong>
      </td>
    </tr>
  </table>
