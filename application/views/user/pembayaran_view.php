      ...
      <div class="card-body">
        ...
        <div class="container-fluid pr-3">
          <img src="<?= base_url('assets'); ?>/img/<?php
                                                    ...
                                                    ?>" alt="<?php echo $pembayaran['tanggal_pembayaran']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded" width="300px">
            ...
            <div class="table-responsive pr-3">
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="font-weight-bold text-success">Lakukan pembayaran kamar offline (Melalui Teknisi Kost, dengan meminta struk pembayaran) atau transfer ke <br><br>(Rekening no. Rekening
                      784701006938535 (BRI) A.N. Raihan Hafiz) <br><br> Foto/Scan Bukti pembayaran dan upload saat melakukan pembayaran</td>
                  </tr>
                </tbody>
              </table>
              <form action="<?= base_url('user/createpembayaran'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input value="<?php echo ($harga_kamar['harga_total'] + $totalDenda); ?>" type="hidden" class="form-control" id="nominal" name="nominal" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input value="<?php echo $harga_kamar['id_menghuni'] ?>" type="hidden" class="form-control" id="menghuni" name="id_menghuni" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" required>
                </div>
                <div class="form-group">
                  <label for="tanggal">Tanggal Pembayaran</label>
                  <input value="<?php echo $harga_kamar['tanggal_sekarang'] ?>" type="date" class="form-control" id="tanggal" name="tanggal" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input value="" type="file" class="form-control-file" id="profil" name="bukti_pembayaran" aria-describedby="profil" accept="image/*" required>
                </div>
