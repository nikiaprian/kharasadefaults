        ...
        <div class="container-fluid">
        	...
        	<!-- Page Heading -->
        	<h1 class="h3 mb-2 text-gray-800">Tipe Hunian</h1>

        	<!-- DataTales Example -->
        	<div class="card shadow mb-4">
        		<div class="card-header py-3">
        			<!-- judul tabel -->
        			<span class="m-0 font-weight-bold text-primary">Master Data Tipe Hunian</span>

        			<!-- button tambah -->
        			<button id="btn_tambah" class="btn btn-sm btn-primary btn-icon-split float-right" data-toggle="modal" data-target="#tambahTipe">
        					...
        					<tbody>
								...
								?>
        							<tr>
        								...
        								<td>
        									<button type="button" id="<?php echo $t['id_tipe']; ?>" class="btn btn-success btn-circle btn-sm view_data m-1">
        	...
        	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
        				<h5 class="modal-title text-primary font-weight-bold" id="exampleModalCenterTitle">Tambah Tipe Hunian</h5>
        			...
        			<div class="modal-body">
        				<form action="<?= site_url('Admin/saveTipeKamar'); ?>" method="POST">
        					...
        					<div class="form-group">
        						<label for="inputTipeKamar">Nama Tipe Hunian</label>
        						<input name="namaTipe" type="text" class="form-control" id="namaTipe" aria-describedby="emailHelp" placeholder="Tipe kamar baru" required>
        					</div>
        ...
        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        	<div class="modal-dialog modal-dialog-centered" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
        				<h5 class="modal-title text-primary font-weight-bold" id="exampleModalCenterTitle">Edit Tipe Hunian</h5>
        				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
        					<span aria-hidden="true">&times;</span>
        				</button>
        			</div>
