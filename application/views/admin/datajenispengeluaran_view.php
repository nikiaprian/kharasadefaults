  						...
  						<?php
							...
							?>
  							<tr>
  								...
  								<td>
  									<button id="<?php echo $row['id_jenis_pengeluaran']; ?>" class="btn btn-success btn-circle btn-sm view_data" data-toggle="tooltip" data-placement="top" title="Edit Record">
  										<i class="fas fa-pen"></i>
  									</button>
  									<a href="<?php echo base_url('delete/jenisPengeluaranById/') . $row['id_jenis_pengeluaran']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus Layanan Ini" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
  			...
  			<div class="modal-body">
  				...
  				<form action="<?= base_url('admin/createdatajenispengeluaran'); ?>" method="POST">
  					<div class="form-group">
  						...
  						<input name="kode_pengeluaran" pe="text" class="form-control" id="inputKode" aria-describedby="emailHelp" placeholder="Masukkan kode untuk jenis pengeluaran baru anda" required>
  					</div>

  					<div class="form-group">
  						<label for="inputKategori">Kategori</label>
  						<select name="kategori" type="text" class="form-control" id="inputKategori" placeholder="Masukkan kategori pengeluaran anda" required>
  					...
  					<div class="form-group">
  						...
  						<input name="nama" type="text" class="form-control" id="inputNama" placeholder="Nama jenis pengeluaran" required>
  					</div>
