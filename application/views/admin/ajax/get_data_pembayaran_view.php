...
<div class="container-fluid">
	<a href="<?php
		...
		<img src="<?php
					...
					?>" alt="<?php echo $pembayaran['tanggal_pembayaran']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded" width="300px"> </a>
	<div class="table-responsive">
		<table class="table">
			<tbody>
				<tr>
					<td class="font-weight-bold" width="30%">No. Hunian</td>
					<td><?php echo 'Hunian no.' . $pembayaran['nomor_kamar']; ?></td>
				</tr>
				<tr>
