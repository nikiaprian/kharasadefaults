...
<form action="<?= base_url('update/updateMenghuni'); ?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <select name="kamar" class="form-control" id="kamar" required>
      <option disabled value="">Pilih Hunian</option>
  ...
  <div class="form-group">
    ...
    <input type="date" value="<?php echo $menghuni['tanggal_masuk'] ?>" class="form-control" id="tanggal" name="tanggal" aria-describedby="tanggal" placeholder="Masukkan Tanggal Masuk" required>
  </div>
  <div class="modal-footer">
    <button type="button" data-dismiss="modal" class="btn btn-secondary">Close</button>
    <button type="submit" name="update_menghuni" class="btn btn-primary" onclick="return confirm('Anda yakin ingin mengupdate data?');">Update</button>
  </div>
</form>
<?php
