...
<form action="<?= base_url('update/updatebooking'); ?>" method="POST" enctype="multipart/form-data">
  ...
  <a href="<?= base_url('assets'); ?>/img/<?php
    ...
    <img src="<?= base_url('assets'); ?>/img/<?php
                                              ...
                                              ?>" alt="<?php echo $booking['tanggal_booking']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded" width="300px"> </a>

  <div class="table-respomsive">
    <table class="table">
      <tbody>
        <tr>
          <td class="font-weight-bold" width="30%">No. Hunian</td>
          <td><?php echo 'Hunian no.' . $booking['nomor_kamar']; ?></td>
        </tr>
        <tr>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" name="update_booking" class="btn btn-primary" onclick="return confirm('Anda yakin ingin mengupdate data?');">Update</button>
  </div>
</form>
