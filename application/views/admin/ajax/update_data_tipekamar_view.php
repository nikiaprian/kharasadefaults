...
<form action="<?= base_url('update/updatedatatipekamar'); ?>" method="POST">
  ...
  <div class="form-group">
    <label for="namaTipe">Nama Tipe Hunian</label>
    <input value="<?php echo $tipe_kamar['nama_tipe']; ?>" type="text" class="form-control" id="namaTipe" name="namaTipe" aria-describedby="Nomor induk kewarganegaraan" placeholder="Masukkan NIK baru" required>
  </div>
