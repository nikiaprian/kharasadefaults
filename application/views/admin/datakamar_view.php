        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="h3 mb-0 text-gray-800">Data Hunian</span>
            ...
            <button id="btn_tambah" class="btn btn-sm btn-primary btn-icon-split float-right" data-toggle="modal" data-target="#tambahEdit-kamar">
              ...
              <span class="text">Tambah Hunian</span>
            </button>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Daftar Data Hunian</h6>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo 'Hunian. ' . $row->nomor_kamar; ?></td>
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title text-primary font-weight-bold" id="exampleModalCenterTitle">Tambah Hunian</h5>
              ...
              <div class="modal-body">
                <form action="<?= site_url('Admin/saveKamar'); ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="nomorKamar">Nomor Hunian</label>
                  ...
                  <div class="form-group">
                    <label for="tipe">Tipe Hunian</label>
                  ...
                  <div class="form-group">
                    <label for="luas">Luas Hunian</label>
                    <input value="" type="text" class="form-control" id="luas" name="luas" aria-describedby="luas" placeholder="Masukkan luas hunian baru" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="profil">Foto Hunian</label>
        ...
        <div class="modal fade" id="viewDetails" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="viewDetailsLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title text-primary" id="viewDetailsLabel"><strong>Rincian Data Hunian</strong></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                ...
                <div class="container">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-lg-3">Nomor Hunian</div>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-lg-3">Luas Hunian</div>
                        <div class="col-lg-1">:</div>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-lg-3">Lantai Hunian</div>
                        <div class="col-lg-1">:</div>
        ...
        <script>
          $(document).ready(function() {
            ...
            $("#dataTable").on('click', '.edit_data', function() {
              ...
              $('#tambahEdit-kamar h5').text('Edit Hunian');
