...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-3">
		<span class="h3 mb-0 text-gray-800">Booking Hunian</span>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Daftar Booking Hunian</h6>
		</div>
		<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<!-- view btn -->
									<button name="view" type="button" value="view" id="<?php echo $row['id_booking']; ?>" class="btn btn-primary btn-circle btn-sm view_data m-1" title="Lihat Detail">
									...
									<!-- delete btn -->
									<a href="<?= base_url('delete/deletebooking/') . $row['id_booking']; ?>" class="btn btn-danger btn-circle btn-sm m-1" title="Hapus Data Kamar" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
