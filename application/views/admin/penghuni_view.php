...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">Data Master Penghuni</h1>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<!-- view btn -->
									<button name="view" type="button" value="view" id="<?= $row['id_pengguna']; ?>" class="btn btn-primary btn-circle btn-sm view_data m-1" title="Lihat Detail">
									...
									<!-- delete btn -->
									<a href="<?= base_url('delete/penghunibyid/') . $row['id_pengguna']; ?>" class="btn btn-danger btn-circle btn-sm m-1" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
