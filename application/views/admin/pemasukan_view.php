          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <!-- view btn -->
                  <button name="view" type="button" value="view" id="<?php echo $row['id_pembayaran']; ?>" class="btn btn-primary btn-circle btn-sm view_data m-1" title="Lihat Detail">
                  ...
                  <!-- delete btn -->
                  <a href="<?php echo base_url('delete/delpembayaran/') . $row['id_pembayaran']; ?>" class="btn btn-danger btn-circle btn-sm m-1" title="Hapus Data Hunian" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
