...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-3">
		<span class="h3 mb-0 text-gray-800">Data Penghuni</span>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<!-- view btn -->
									<button name="view" type="button" value="view" id="<?php echo $row['id_menghuni']; ?>" class="btn btn-primary btn-circle btn-sm view_data m-1" title="Lihat Detail">
									...
									<!-- delete btn -->
									<a href="<?= base_url('delete/deletemenghuni/'); ?><?= $row['id_menghuni']; ?>/<?= $row['id_pengguna']; ?>" class="btn btn-danger btn-circle btn-sm m-1" title="Hapus Data Kamar" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title text-primary font-weight-bold" id="editJudul">Edit Data Penghuni</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal fade" id="tambah-kamar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title text-primary font-weight-bold" id="exampleModalCenterTitle">Tambah Data Penghuni</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form action="<?= base_url('admin/createMenghuni'); ?>" method="POST" enctype="multipart/form-data">
					<div class="form-group">
						<label for="kamar">Pilih Hunian</label>
						<select name="kamar" class="form-control" id="kamar" required>
							<option selected disabled value="">Pilih Hunian</option>
					...
					<div class="form-group">
						...
						<input value="" type="number" class="form-control" id="nominalBayar" name="nominal" aria-describedby="nominalBayar" placeholder="Masukkan nilai pembayaran" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input value="" type="file" class="form-control-file" id="profil" name="bukti_bayar" aria-describedby="profil" accept="image/*" required>
					</div>
					<div class="modal-footer">
