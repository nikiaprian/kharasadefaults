                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['datetime']; ?></td>
                                <td>
                                    <a href="<?= base_url('delete/reviewbyid/') . $row['review_id']; ?>" class="btn btn-danger btn-circle btn-sm m-1" onclick="return confirm('Anda yakin ingin menghapus data ini? Data yang dihapus tidak dapat dikembalikan!');">
