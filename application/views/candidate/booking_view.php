	...
	<div class="d-sm-flex align-items-center justify-content-between mb-3">
		<span class="h3 mb-0 text-gray-800">Reservasi Hunian</span>
	</div>
					...
					<div class="container-fluid pr-3">
						...
						<div class="table-responsive pr-3">
							<table class="table">
								<tbody>
									<tr>
										<td class="font-weight-bold" width="30%">Hunian Yang Dipesan</td>
										<td><?php echo 'Hunian no. ' . $pembayaran_booking['nomor_kamar'];
											?>
										</td>
									</tr>
									<tr>
									...
									<?php } else { ?>
										...
										<tr>
											...
											<td class="font-weight-bold text-success">Pembayaran Telah Dikonfirmasi. Harap
												Logout dan Sign In kembali untuk melanjutkan. <br><br><button type="button" class="btn btn-primary btn-block" data-target="#logoutModal" data-toggle="modal">Log Out</button></td>
										</tr>
	...
	<?php } else { ?>
			...
			?>
				<div class="col col-12 col-sm-6 col-lg-3 mb-4 d-flex align-items-stretch">
					<div class="card">
						...
						<?php } else { ?>
							<img src="<?= base_url('assets'); ?>/img/<?php echo $row['foto_kamar']; ?>" height="200px" class="card-img-top" alt="...">
						<?php } ?>
						...
						<div class="d-flex flex-column card-body">
							...
							<div class="btn-group mt-auto" role="group" aria-label="Basic example">
								<button name="view" value="view" id="<?php echo $row['id_kamar']; ?>" class="btn btn-outline-primary view_data">Lihat Detail</button>
								<button name="view" value="view" id="<?php echo $row['id_kamar']; ?>" class="btn btn-outline-success booking_kamar">Booking</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal fade" id="bookingKamar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title text-primary font-weight-bold" id="exampleModalCenterTitle">Booking Hunian
						</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
