...
?>
	<div class="container">
		...
		<div class="row justify-content-center align-items-center">
			<a href="<?= base_url('candidate/settingsprofil'); ?>" class="btn btn-primary justify-content-center mb-3 mt-3">Lengkapi Data Diri</a>
		</div>
	</div>
	<?php
	...
	?>
		<form action="<?= base_url('candidate/createBooking'); ?>" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				<input value="<?php echo $kamar['nomor_kamar']; ?>" type="hidden" class="form-control" id="nomorKamar" name="nomorKamar" aria-describedby="Nomor Kamar" placeholder="Masukkan nomor hunian baru" readonly>
			</div>
			<div class="container-fluid">
				...
				<div class="table-respomsive">
					<table class="table">
						<tbody>
							<tr>
								<td class="font-weight-bold" width="30%">Nomor Hunian</td>
							...
							<tr>
								<td class="font-weight-bold" width="30%">Luas Hunian</td>
							...
							<tr>
								<td class="font-weight-bold" width="30%">Deskripsi Hunian</td>
							...
							<tr>
								...
								<td class="font-weight-bold" width="100%">Lakukan Pembayaran Booking Kamar ke no. Rekening
									784701006938535 (BRI) A.N. Raihan Hafiz. Upload Struk (Bukti Bayar) dibawah ini</td>
							</tr>
						</tbody>
					</table>
				</div>
		...
		<div class="form-group">
			<label class="ml-4 font-weight-bold text-danger" for="profil">Upload Bukti Pembayaran (Lakukan Pembayaran
				Terlebih Dahulu Untuk Memesan Hunian)</label>
			<input value="<?php echo $kamar['foto_kamar']; ?>" type="file" class="form-control-file ml-4" id="profil" name="bukti_booking" aria-describedby="profil" accept="image/*" required>
		</div>

		<div class="modal-footer">
			<button type="button" data-dismiss="modal" class="btn btn-secondary">Close</button>
			<button type="submit" name="submitBooking" class="btn btn-primary" onclick="return confirm('Anda yakin ingin mengupdate data?');">Booking Hunian</button>
		</div>
		</form>
	<?php
}
