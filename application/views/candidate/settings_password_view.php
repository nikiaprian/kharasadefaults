    ...
    <div class="card-body">
      ...
      <form class="needs-validation" method="POST" novalidate>
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="pass_lama" name="pass_lama" aria-describedby="Password Lama" placeholder="Masukkan password lama" required>
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="pass_baru" name="pass_baru" aria-describedby="Password Baru" placeholder="Masukkan password baru" required>
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="passBaruVerifikasi" name="pass_baru_verifikasi" aria-describedby="Verifikasi Password Baru" placeholder="Verifikasi password baru" required>
          <div class="invalid-feedback">
