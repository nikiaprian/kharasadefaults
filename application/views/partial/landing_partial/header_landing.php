...
<head>
	...
	<title>KHARASA HOUSE | Cari, Bayar, & Sewa</title>
</head>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					<div class="navbar-nav ml-auto">
						...
						<a class="nav-item btn btn-light tombol tombol-nav" href="<?= base_url('register') ?>" tabindex="-1" aria-disabled="true">Daftar</a>
						<a class="nav-item btn btn-light tombol tombol-nav" href="<?= base_url('login') ?>" tabindex="-1" aria-disabled="true">Masuk</a>
					</div>
				</div>
			</div>
		</nav>
