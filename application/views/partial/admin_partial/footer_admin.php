...
<?php elseif ($menu == 'kamar' && $subMenu == 'komplain') : ?>
  <script>
    // edit data
    $('#dataTable').on('click', '.edit_data', function() {
      var $tr = $(this).closest('tr');
      ...
      var id_komplain = data[1];
      console.log(id_komplain);

      var judul = "Update Komplain id: ";
      var stringJudul = judul + id_komplain
