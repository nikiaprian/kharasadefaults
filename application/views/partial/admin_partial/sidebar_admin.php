	...
	<?php if ($menu == 'penghuni') : ?>
		...
		<li class="nav-item active">
			<a class="nav-link" href="<?= base_url('admin/penghuni'); ?>">
				...
				<span>Data Master Penghuni</span></a>
		</li>
	<?php else : ?>
		<!-- Nav Item - Charts -->
		<li class="nav-item">
			...
			<li class="nav-item active">
				...
				<div id="collapseKamar" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="<?= base_url('admin/bookingkamar'); ?>">Booking Hunian</a>
						<a class="collapse-item" href="<?= base_url('admin/datakamar'); ?>">Data Hunian</a>
						<a class="collapse-item" href="<?= base_url('admin/menghuni'); ?>">Penghuni</a>
						<a class="collapse-item" href="<?= base_url('admin/komplain'); ?>">Data Komplain</a>
						<a class="collapse-item" href="<?= base_url('admin/review'); ?>">Data Review</a>
					</div>
				</div>
			</li>
		<?php elseif ($subMenu == 'data_kamar') : ?>
			...
			<li class="nav-item active">
				...
				<div id="collapseKamar" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Menu:</h6>
						<a class="collapse-item" href="<?= base_url('admin/bookingkamar'); ?>">Booking Hunian</a>
						<a class="collapse-item active" href="<?= base_url('admin/datakamar'); ?>">Data Hunian</a>
						<a class="collapse-item" href="<?= base_url('admin/menghuni'); ?>">Penghuni</a>
						<a class="collapse-item" href="<?= base_url('admin/komplain'); ?>">Data Komplain</a>
						<a class="collapse-item" href="<?= base_url('admin/review'); ?>">Data Review</a>
					</div>
			...
			<li class="nav-item active">
				...
				<div id="collapseKamar" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('admin/bookingkamar'); ?>">Booking Hunian</a>
						<a class="collapse-item" href="<?= base_url('admin/datakamar'); ?>">Data Hunian</a>
						<a class="collapse-item active" href="<?= base_url('admin/menghuni'); ?>">Penghuni</a>
						<a class="collapse-item" href="<?= base_url('admin/komplain'); ?>">Data Komplain</a>
						<a class="collapse-item" href="<?= base_url('admin/review'); ?>">Data Review</a>
					</div>
				</div>
			...
			<li class="nav-item active">
				...
				<div id="collapseKamar" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('admin/datakamar'); ?>">Data Hunian</a>
						<a class="collapse-item" href="<?= base_url('admin/menghuni'); ?>">Penghuni</a>
						<a class="collapse-item active" href="<?= base_url('admin/komplain'); ?>">Data Komplain</a>
						<a class="collapse-item" href="<?= base_url('admin/review'); ?>">Data Review</a>
					</div>
				</div>
			</li>

		<?php elseif ($subMenu == 'review') : ?>
			<!-- Nav Item - Kamar Collapse Menu -->
			<li class="nav-item active">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseKamar" aria-expanded="true" aria-controls="collapseKamar">
					<i class="fas fa-fw fa-bed"></i>
				...
				<div id="collapseKamar" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('admin/menghuni'); ?>">Penghuni</a>
						<a class="collapse-item" href="<?= base_url('admin/komplain'); ?>">Data Komplain</a>
						<a class="collapse-item active" href="<?= base_url('admin/review'); ?>">Data Review</a>
					</div>
				</div>
			</li>
		<?php endif; ?>
				...
				<div id="collapseMaster" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('admin/datajenispengeluaran'); ?>">Data Jenis
							Pengeluaran</a>
						<a class="collapse-item" href="<?= base_url('admin/datatipekamar'); ?>">Data Tipe Hunian</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item active">
				...
				<div id="collapseMaster" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('admin/datajenispengeluaran'); ?>">Data Jenis
							Pengeluaran</a>
						<a class="collapse-item active" href="<?= base_url('admin/datatipekamar'); ?>">Data Tipe Hunian</a>
					</div>
				</div>
			</li>
