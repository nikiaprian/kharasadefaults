...
class Laporan_model extends CI_Model
{
    ...
    {
        $query = "SELECT *, DATE_FORMAT(pembayaran.tanggal_pembayaran, '%d %M %Y') AS tanggal_bayar FROM pembayaran, penghuni, kamar, pengguna, jenis_status_pembayaran
            WHERE pembayaran.id_menghuni = penghuni.id_menghuni AND
            penghuni.id_kamar = kamar.id_kamar AND
            penghuni.id_pengguna = pengguna.id_pengguna AND
