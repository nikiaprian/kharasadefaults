...
class Pembayaran_model extends CI_Model
{
  ...
  public function getPendingIncome()
  {
    ...
    $this->db->from('pengguna');
    $this->db->join('penghuni', 'pengguna.id_pengguna = penghuni.id_pengguna');
    $this->db->join('pembayaran', 'penghuni.id_menghuni = pembayaran.id_menghuni');
  ...
  public function getAllIncome()
  {
    ...
    $this->db->from('pembayaran');
    $this->db->join('penghuni', 'pembayaran.id_menghuni = penghuni.id_menghuni');
    $this->db->join('kamar', 'penghuni.id_kamar = kamar.id_kamar');
    $this->db->join('pengguna', 'penghuni.id_pengguna = pengguna.id_pengguna');
