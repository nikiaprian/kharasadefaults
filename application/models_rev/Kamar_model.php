...
class Kamar_model extends CI_Model
{
    ...
    {
        $query = "SELECT *, (kamar.harga_bulanan + layanan.harga_bulanan) AS total_harga, layanan.harga_bulanan AS harga_layanan, kamar.harga_bulanan AS harga_kamar_bulanan FROM pengguna, kamar, penghuni, layanan, tipe_kamar WHERE pengguna.id_pengguna = $id_pengguna AND penghuni.id_pengguna = pengguna.id_pengguna AND penghuni.id_kamar = kamar.id_kamar AND kamar.id_layanan = layanan.id_layanan AND kamar.id_tipe = tipe_kamar.id_tipe";
