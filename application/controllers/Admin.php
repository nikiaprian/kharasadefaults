...
class Admin extends CI_Controller
{
    ...
    public function komplain()
    {
        ...
        $data['tittle'] = "Data Komplain";
        $data['menu'] = 'kamar';
        $data['subMenu'] = 'komplain';
        $data['user'] = $this->User_model->getUserById($id_pengguna);
        $data['level'] = $this->User_model->getHakAksesById($id_akses);
        $data['data_komplain'] = $this->User_model->getAllKomplain();
        $data['jenis_status'] = $this->User_model->getAllStatusKomplain();

        $this->load->view('partial/admin_partial/header_admin.php', $data);
        $this->load->view('partial/admin_partial/sidebar_admin.php', $data);
        $this->load->view('partial/admin_partial/topbar_admin.php', $data);
        $this->load->view('admin/komplain_view.php', $data);
        $this->load->view('partial/admin_partial/footer_admin.php', $data);
    }
    ...
    public function review()
    {
        ...
        $this->load->view('partial/admin_partial/sidebar_admin.php', $data);
        $this->load->view('partial/admin_partial/topbar_admin.php', $data);
        $this->load->view('admin/review_view.php', $data);
        $this->load->view('partial/admin_partial/footer_admin.php', $data);
    }
    ...
    public function ajax()
    {
        ...
        } else if ($ajax_menu == 'edit_komplain') {
            $id_komplain = $this->input->post('id_komplain');

            $data['komplain'] = $this->Menghuni_model->getKomplainById($id_komplain);
            $data['status_komplain'] = $this->User_model->getAllStatusKomplain();

            $this->load->view('admin/ajax/update_komplain_view', $data);
        }
    }
