...
class menghuni_model extends CI_Model
{
    ...
    public function getKomplainById($id_komplain)
    {
        $query = "SELECT komplain.id_komplain, komplain.tanggal_komplain, komplain.perihal, komplain.isi, komplain.status_komplain, pengguna.nama_pengguna, kamar.id_kamar, kamar.nomor_kamar, pengguna.id_pengguna, pengguna.nama_pengguna FROM pengguna, kamar, komplain, status_komplain WHERE pengguna.id_pengguna = komplain.id_pengguna AND kamar.id_kamar = komplain.id_kamar AND komplain.id_komplain = '$id_komplain'";
    ...
    public function updateKomplain($id_komplain, $data)
    {
